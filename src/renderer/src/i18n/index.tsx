...
const MESSAGES: Record<AppLanguage, TranslationTable> = {
  en: {
    ...
    'history.copyFailed': 'Unable to copy right now.',
    'history.retry': 'Retry',
    ...
    'dictationFallback.title': 'Dictation is ready to copy',
    'dictationFallback.body':
      'We could not confirm an input was focused, so your dictated text is saved here instead.',
    'dictationFallback.pasteFailedBody':
      'The paste shortcut did not complete, so your dictated text is saved here instead.',
    'dictationFallback.copyAction': 'Copy dictated text',
    'meetings.total': 'Meetings',
    'meetings.shortcut': 'Shortcut',
    'meetings.storage': 'Storage',
    'meetings.local': 'Local',
    'meetings.title': 'Meeting history',
    'meetings.description': ({ totalCount }) =>
      `Browse ${totalCount} saved meeting captures with local audio and transcripts.`,
    'meetings.refresh': 'Refresh',
    'meetings.loading': 'Loading meetings…',
    'meetings.emptyTitle': 'No meeting captures yet',
    'meetings.emptyBody': 'Use Control+R to start a meeting capture when you are ready.',
    'meetings.openDetail': ({ title }) => `Open meeting details for ${title}`,
    'meetings.fallbackTitle': 'Meeting capture',
    'meetings.duration': ({ duration }) => `Duration ${duration}`,
    'meetings.page': ({ current, total }) => `Page ${current} of ${total}`,
    ...
    'meetings.llmProcessing.pending': 'Summary pending',
    'meetings.llmProcessing.completed': 'Summary ready',
    'meetings.llmProcessing.failed': 'Summary failed',
    'meetings.detailTitle': 'Meeting details',
    'meetings.detailDescription': 'Summary, transcript, and saved meeting audio.',
    'meetings.loadingDetail': 'Loading meeting details…',
    'meetings.audio': 'Meeting audio',
    'meetings.summary': 'Summary',
    'meetings.noSummary': 'No summary captured yet.',
    'meetings.polishedTranscript': 'Polished transcript',
    'meetings.noPolishedTranscript': 'No polished transcript captured yet.',
    'meetings.rawTranscript': 'Raw transcript',
    'meetings.noRawTranscript': 'No raw transcript captured yet.',
    'meetings.errorDetail': 'Error detail',
    'meetings.noDetail': 'This meeting capture is no longer available.',
    ...
    'settings.shortcut.liveCaption': 'Live Caption',
    'settings.shortcut.liveCaptionDetail': 'Opens the language setup before captions start.',
...
MESSAGES['zh-CN'] = {
  ...
  'dictationFallback.title': '转写内容可复制',
  'dictationFallback.body': '没有确认当前焦点在输入框内，已把这次口述内容保存在这里。',
  'dictationFallback.pasteFailedBody': '粘贴快捷键没有完成，已把这次口述内容保存在这里。',
  'dictationFallback.copyAction': '复制口述内容',
  'meetings.total': '会议',
  'meetings.shortcut': '快捷键',
  'meetings.storage': '存储',
  'meetings.local': '本机',
  'meetings.title': '会议历史',
  'meetings.description': ({ totalCount }) =>
    `浏览 ${totalCount} 条已保存的会议捕获，包含本地音频和转写。`,
  'meetings.refresh': '刷新',
  'meetings.loading': '会议加载中…',
  'meetings.emptyTitle': '还没有会议捕获',
  'meetings.emptyBody': '准备好时按 Control+R 开始会议捕获。',
  'meetings.openDetail': ({ title }) => `打开会议详情：${title}`,
  'meetings.fallbackTitle': '会议捕获',
  'meetings.duration': ({ duration }) => `时长 ${duration}`,
  'meetings.page': ({ current, total }) => `第 ${current} / ${total} 页`,
  'meetings.status.recording': '录制中',
  'meetings.status.processing': '处理中',
  'meetings.status.completed': '已完成',
  'meetings.status.failed': '失败',
  'meetings.llmProcessing.pending': '总结待处理',
  'meetings.llmProcessing.completed': '总结已完成',
  'meetings.llmProcessing.failed': '总结失败',
  'meetings.detailTitle': '会议详情',
  'meetings.detailDescription': '会议总结、转写和保存的会议音频。',
  'meetings.loadingDetail': '会议详情加载中…',
  'meetings.audio': '会议音频',
  'meetings.summary': '总结',
  'meetings.noSummary': '还没有会议总结。',
  'meetings.polishedTranscript': '润色转写',
  'meetings.noPolishedTranscript': '还没有润色转写。',
  'meetings.rawTranscript': '原始转写',
  'meetings.noRawTranscript': '还没有原始转写。',
  'meetings.errorDetail': '错误详情',
  'meetings.noDetail': '这条会议捕获已不可用。',
  'common.showAll': '查看全部',
  ...
  'presets.libraryDescription': '点击即可启用预设。你也可以编辑提示词，或将内置预设恢复为默认值。',
  ...
  'presetEditor.promptOrderBody': '基础提示词 → 预设提示词 → 转写内容和已选中的文本上下文。',
  ...
  'settings.shortcut.liveCaption': '实时字幕',
  'settings.shortcut.liveCaptionDetail': '开始字幕前打开语言设置。',
...
MESSAGES['zh-TW'] = {
  ...
  'common.dismiss': '關閉',
  'history.copy': '複製',
  'history.copying': '正在複製...',
  'history.copied': '已複製到剪貼簿。',
  'history.copyFailed': '暫時無法複製。',
  'history.retry': '重試',
  ...
  'dictationFallback.title': '轉寫內容可複製',
  'dictationFallback.body': '沒有確認目前焦點在輸入框內，已將這次口述內容保存在這裡。',
  'dictationFallback.pasteFailedBody': '貼上快捷鍵沒有完成，已將這次口述內容保存在這裡。',
  'dictationFallback.copyAction': '複製口述內容',
  'common.showAll': '查看全部',
  ...
  'presets.libraryDescription': '點擊即可啟用預設。你也可以編輯提示詞，或將內建預設恢復為預設值。',
  ...
  'presetEditor.promptOrderBody': '基礎提示詞 → 預設提示詞 → 轉寫內容和已選取的文字上下文。',
  ...
  'settings.shortcut.liveCaption': '即時字幕',
  'settings.shortcut.liveCaptionDetail': '開始字幕前打開語言設定。',
