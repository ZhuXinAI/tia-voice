...
MESSAGES['zh-CN'] = {
  ...
  'common.showAll': '查看全部',
  'presets.badge': '预设决定 PostProcess 提示词的形状',
  'presets.heroTitle': '调整位于基础提示词与实时上下文之间的指令层。',
  'presets.heroBody':
    '为日常使用选择一个预设，在输出语气需要变化时改写它的指令，并为其他写作风格或工作流新增预设。',
  'presets.layer.base': '1 基础提示词',
  'presets.layer.preset': '2 预设提示词',
  'presets.layer.context': '3 剩余上下文',
  'presets.libraryTitle': '预设库',
  'presets.libraryDescription':
    '点击预设即可启用。你也可以编辑提示词，或将内置预设重置为默认内容。',
  ...
  'presets.validationSelectPreset': '请先选择一个预设再保存。',
  ...
  'presetEditor.promptOrderBody':
    '先是基础提示词，再是当前预设提示词，最后是剩余转写内容与已选中文本上下文。',
...
MESSAGES['zh-TW'] = {
  ...
  'common.showAll': '查看全部',
  'presets.badge': '預設決定 PostProcess 提示詞的形狀',
  'presets.heroTitle': '調整位於基礎提示詞與即時上下文之間的指令層。',
  'presets.heroBody':
    '為日常使用選擇一個預設，在輸出語氣需要改變時改寫它的指令，並為其他寫作風格或工作流程新增預設。',
  'presets.layer.base': '1 基礎提示詞',
  'presets.layer.preset': '2 預設提示詞',
  'presets.layer.context': '3 剩餘上下文',
  'presets.libraryTitle': '預設庫',
  'presets.libraryDescription':
    '點擊預設即可啟用。你也可以編輯提示詞，或把內建預設重設為預設內容。',
  ...
  'presets.validationSelectPreset': '請先選擇一個預設再儲存。',
  ...
  'presetEditor.promptOrderBody':
    '先是基礎提示詞，再是目前預設提示詞，最後是剩餘轉寫內容與已選文字上下文。',
